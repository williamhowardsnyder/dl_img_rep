...
def parse_arguments():
    ...
    parser.add_argument(
        "--save-reps", help="save the 16, 32, 64, 128, 256, and 2048 dimensional representations",
        default=None
    )
    ...
    parser.add_argument(
        "--config", help="Config file to use (see configs dir)", default="/home/howarwil/nested-rep/hidden-networks/configs/largescale/baselines/resnet50-dense.yaml"
    )
    parser.add_argument(
