...
def main_worker(args):
    ...
    elif args.save_reps and args.pretrained: # We should save the representations of the pretrained model
        validate(
            data.val_loader, model, criterion, args, writer=None, epoch=1, save_to="2048dim_val_reps"
        )
        
        validate(
            data.train_loader, model, criterion, args, writer=None, epoch=1, save_to="2048dim_train_reps"
        )
