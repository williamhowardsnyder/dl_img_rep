...
class ResNet(nn.Module):
    def __init__(self, builder, block, num_blocks):
        ...
        if args.last_layer_dense:
            ...
            self.fc16 = builder.conv1x1(16 * block.expansion, 10)
            self.fc32 = builder.conv1x1(32 * block.expansion, 10)
            self.fc64 = builder.conv1x1(64 * block.expansion, 10)
            self.fc128 = builder.conv1x1(128 * block.expansion, 10)
            self.fc256 = builder.conv1x1(256 * block.expansion, 10)
    ...
    def forward(self, x):
        ...
        return out512.flatten(1), out16.flatten(1), out32.flatten(1), out64.flatten(1), out128.flatten(1), out256.flatten(1)
